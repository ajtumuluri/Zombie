...
class ScenariosControllerTest < ActionController::TestCase
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post :create, scenario: { health: @scenario.health, name: @scenario.name, scenario: @scenario.scenario, user_interaction: @scenario.user_interaction }
    end
  ...
  test "should update scenario" do
    patch :update, id: @scenario, scenario: { health: @scenario.health, name: @scenario.name, scenario: @scenario.scenario, user_interaction: @scenario.user_interaction }
    assert_redirected_to scenario_path(assigns(:scenario))
  end
